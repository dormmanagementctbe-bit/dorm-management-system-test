...
exports.generateAllocationPdf = generateAllocationPdf;
const pdf_lib_1 = require("pdf-lib");
async function generateAllocationPdf(allocation) {
    ...
    const margin = 50;
    const primaryColor = (0, pdf_lib_1.rgb)(0.13, 0.29, 0.53); // dark blue
    const gray = (0, pdf_lib_1.rgb)(0.4, 0.4, 0.4);
    ...
    page.drawRectangle({
        ...
        height: 70,
        color: (0, pdf_lib_1.rgb)(0.95, 0.97, 1),
