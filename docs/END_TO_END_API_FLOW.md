...
## 8) Upload Required Documents (Local Storage)
...
Use the returned `storagePath` values in the application payload below.

## 9) Student Submits Dorm Application
...
## 10) Student Updates Application Within 24 Hours
